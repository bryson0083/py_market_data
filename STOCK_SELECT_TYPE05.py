...
def MAIN_STOCK_SELECT_TYPE05():
	...
	name = "STOCK_SELECT_TYPE05_" + str_date + ".txt"
	...
	#結果寫入EXCEL檔
	file_name = 'STOCK_SELECT_TYPE05_' + str_date + '.xlsx'
