...
def STORE_DB(arg_df, arg_date):
	...
	if commit_flag == True:
		conn.commit()
		print(quo_date + " 證交所~每日信用交易統計、融資融券彙總，寫入成功.\n")
		file.write(quo_date + " 證交所~每日信用交易統計、融資融券彙總，寫入成功.\n")
	else:
		conn.execute("rollback")
		print(quo_date + " 證交所~每日信用交易統計、融資融券彙總，寫入失敗Rollback.\n")
		file.write(quo_date + " 證交所~每日信用交易統計、融資融券彙總，寫入失敗Rollback.\n")
